# test_TimedDriving.py
# This is a simple test script to validate that Project05_TimedDriving.py will execute as intended without throwing any error & the challenges are completed successfully.
...
def test_Project4():
    ...
    try:
        ...
        result = subprocess.run(['python3', 'Project05_TimedDriving.py'], check=True, capture_output=True, text=True) # check if there is any error in the output
...
# test challenge 1
'''
Write functions to test the challenges in Project 5
