...
# - Challenge 1:
#   - Try replacing the driving function in line 141 to make the rover drive in a different direction.
# - Challenge 2:
#   - Try adding other driving functions after line 157 to create a new light-seeking spin pattern.
# - Challenge 3:
...
#   - On line 155, replace ‘if True:’ with ‘if count % 2 == 0:’. This will make the rover alternate directions.
# - Challenge 5:
...
#   - Replace the break statement on line 163 with a driving function to make the rover spin all the way around if the Max_Search_Time is reached.
#
...
while True: # Continuous outer while loop
    ...
    # If there's not enough light, let's look for it by spinning the rover    
        ...
        while not(GPIO.input(Photo_Pin)): # while not enough light detected...
            ...
            if Elapsed_Time < Max_Search_Time: # while not enough light is detected\
                ...
                print('Spinning to search for more light')
                drive_left_turn(5) # turn left for 5 
