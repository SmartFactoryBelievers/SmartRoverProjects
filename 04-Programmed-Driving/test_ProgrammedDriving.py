# test_ProgrammedDriving.py
# This is a simple test script to validate that Project04_ProgrammedDriving.py will execute as intended without throwing any error & the challenges are completed successfully.

# importing the subprocess module allows us to run other programs from this Python file
import subprocess 

# define a function called test_Project4
def test_Project4():
    # This function is execute any time we run the test
    try:
        # Run Project 1 and record the output
        result = subprocess.run(['python3', 'Project04_ProgrammedDriving.py'], check=True, capture_output=True, text=True) # check if there is any error in the output
...
# test challenge 1
'''
Write functions to test the challenges in Project 4
