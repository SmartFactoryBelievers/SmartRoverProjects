...
# - Challenge 1:
#   - The code uses five INPUT variables for drive time in each direct (forward, backward, left turn, & right turn).
...
#   - Rearrange the order of your drive functions in lines 129-132 to create a new driving path.
# - Challenge 3:
...
#   - In lines 129-132, try replacing the drive time variable name with a number. 
...
for n in range(1):
    ...
    sleep(Wait_Time)
    drive_backward(3) # Drive backward for 3 seconds
    drive_right_turn(2) # Turn right for 2 seconds
    drive_forward(1) # Drive forward for 1 second
    drive_left_turn(0.5) # Turn left for 0.5 seconds
