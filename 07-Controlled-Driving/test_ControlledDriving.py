# test_ControlledDriving.py
# This is a simple test script to validate that Project07_ControlledDriving.py will execute as intended without throwing any error & the challenges are completed successfully.
...
def test_Project7():
    ...
    try:
        # Run Project 7 and record the output
        result = subprocess.run(['python3', 'Project07_ControlledDriving.py'], check=True, capture_output=True, text=True) # check if there is any error in the output
