...
Pin_On = 1 # duration of LED flash, seconds
...
# Here's a function for checking if a selector button is pressed
# In_Pin is a variable that tells the function which pin to check
# When you call this function, you tell it the pin number you want to read (for example, A_Pin or C_Pin)
# This way, the same function can check different buttons by using different pin numbers.
...
# Out_Pin is a variable that tells the function which pin to turn on
# When you call this function, you tell it the pin number you want to turn on (for example, LED_Pin or Buzzer_Pin)
# So, the function waits for the duration of a variable called "Delay"
